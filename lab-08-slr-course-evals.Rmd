...
**Answer:** The distribution is skewed to the right, indicating a higher average score.

    What does that tell you about how students rate courses?

**Answer:** This tells me that more students rate their courses and professors highly.

    Is this what you expected to see? Why, or why not?

**Answer:** This is not what I expected to see because many of my friends who go to public institutions purposely give their professors very low scores.

    Include any summary statistics and visualizations you use in your response.
    
```{r}
#| labels: distribution_of_score
#| eval: true
...
```{r}
#| labels: relationship_score_outcome
#| eval: true
...
evals %>%
  ...
  ylab("Average Professor Evaluation Score") +
...
```{r}
#| labels: relationship_score_outcome_jitter
#| eval: true
...
**Answer:**
This lienar model is: score = 3.88 + 0.07 * Beauty Rating.
...
**Answer:**
For an average beauty rating increased by one, the average evaluation rating goes up by 0.07.
...
**Answer:**
For an average beauty rating of zero, the average evaluation rating is 3.88. This does not make sense as there is no person with a beauty rating of zero in the evals dataset.
...
**Answer:**
The model is: score = 4.09 + 0.14 * Male.

A male professor subject on average scores 0.14 higher an evaluations then a female professors. On average, a female professor scores 4.09 on the ratings. 
...
**Answer:**
The average rating for the teaching track professor is 4.28. The average rating for a tenure track professor is 0.12 points lower than a teaching track professor. The avergae rating for a tenured professor is 0.14 points lower than a teaching professor.
...
The average rating for a tenured professor is 4.14. The average rating for a teaching track professor is 0.14 points higher than a tenure professor. The average rating for a tenure track professor is 0.02 points higher than a tenured professor. 
